...
AmCharts.wrappedText = function(a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            for (var r, p = 0; p < l.length; p += Math.ceil(l.length / n)) r = l[p],
            b = b.substr(0, r) + m + b.substr(r + 1);
            if (isNaN(r)) {
                if (0 == k) for (p = 1; p < n; p++) r = Math.round(b.length / n * p),
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    addGuide: function(a) {
        ...
        c = !1,
        d = b.length,
        e = 0; e < b.length; e++) b[e] == a && (c = !0, d = e);
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) c = !0;
            ...
            this.exponential = !1;
            for (f = p; f < r; f += n) t = AmCharts.roundTo(this.step * f + this.min, u),
            ...
            for (f = p; f < r; f += n) if (p = u * f + this.min, d && this.max - this.min > 5 * this.min && (p -= this.min), p = AmCharts.roundTo(p, this.maxDecCount + 1), !this.integersOnly || Math.round(p) == p) if (isNaN(z) || Number(AmCharts.toFixed(p, z)) == p) { ! 0 === d && (0 === p && (p = this.minReal), q > this.logGridLimit && (p = Math.pow(10, f)));
                ...
                if (!isNaN(H) && 0 < t && f < r - 1) {
                    ...
                    for (e = 1; e < u / H; e++) w = this.getCoordinate(p + H * e),
                    w = new this.axisItemRenderer(this, w, "", !1, 0, 0, !1, !1, 0, !0),
                    this.pushAxisItem(w);
                    this.gridAlpha = x
                }
            }
        ...
        q = this.labelsSet;
        this.positionTitle();
        "radar" != a.type ? (a = this.viX, H = this.viY, b.translate(a, H), q.translate(a, H)) : d.toFront(); ! this.visible || c ? (b.hide(), d.hide(), q.hide()) : (b.show(), d.show(), q.show());
    ...
    formatValue: function(a, b, c) {
        ...
        g = this.chart; ! 0 === this.logarithmic && (d = -1 != String(a).indexOf("e") ? !0 : !1);
    ...
    getCoordinate: function(a) {
        ...
        e = this.stepWidth,
        f = this.min,
        g = this.minReal; ! 0 === this.logarithmic ? (0 == a && (a = this.treatZeroAs), a = Math.log(a) * Math.LOG10E - Math.log(g) * Math.LOG10E, b = b ? !0 === c ? d - e * a: e * a: !0 === c ? e * a: d - e * a) : b = !0 === c ? b ? d - e * (a - f) : e * (a - f) : b ? e * (a - f) : d - e * (a - f);
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k, l, m, n) {
        ...
        ba && (ba.translate(ja, U), AmCharts.setCN(p, ba, a.bcn + "tick"), AmCharts.setCN(p, ba, n, !0), g && AmCharts.setCN(p, ba, "guide")); ! 1 === a.visible && (ba && ba.remove(), W && (W.remove(), W = null));
        W && (W.attr({
            "text-anchor": ha
...
AmCharts.AmChart = AmCharts.Class({
    ...
    addListeners: function() {
        var a = this,
        b = a.chartDiv;
        document.addEventListener ? (a.panEventsEnabled && (b.style.msTouchAction = "none"), "ontouchstart" in document.documentElement && (b.addEventListener("touchstart",
        function(b) {
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createXYGraph: function() {
        ...
        for (e = this.start; e <= this.end; e++) {
            ...
            k = g.y,
            g = c.getCoordinate(h),
            l = d.getCoordinate(k); ! isNaN(h) && !isNaN(k) && (a.push(g), b.push(l), h = this.createBullet(f, g, l, e), k = this.labelText) && (f = this.createLabel(f, g, l, k), this.positionLabel(g, l, f, h), this.allBullets.push(f))
        }
    ...
    positionLabel: function(a, b, c, d, e, f) {
        ...
        if (c && "serial" == this.chart.type) if (l) {
            if (0 > b || b > this.height) c.remove(),
            c = !1
        } else if (0 > a || a > this.width) c.remove(),
        c = !1;
        return c
    },
    ...
    createSerialGraph: function() {
        ...
        Q = [],
        Ja = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g) if (this.stackable && "regular" == X || "100%" == X || this.fillToGraph) Ja = !0;
        ...
        for (J = ca; J <= oa; J++) {
            ...
            if (Aa) {
                ...
                if ("candlestick" == g || "ohlc" == g) V = Aa.close,
                vb = Aa.low,
                ...
                if (!wb && V < la || wb && V < sa) v.isNegative = !0,
                Ia && (Ha = Ia),
                Wa && (Ra = Wa),
                void 0 != Ba && (za = Ba);
                Xa = !1;
                ...
                case "line":
                    if (isNaN(V)) z || (this.drawLineGraph(x, t, P, Q), x = [], t = [], P = [], Q = []);
                        ...
                        if (Math.abs(F - gb) >= ib || Math.abs(E - hb) >= ib) x.push(F),
                        t.push(E),
                        gb = F,
                        hb = E;
                        xa = F;
                        ya = E;
                        fa = F;
                        ga = E; ! Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K));
                        if (Xa || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) this.drawLineGraph(x, t, P, Q),
                        x = [F],
                        t = [E],
                        P = [],
                        Q = [],
                        !Ja || isNaN(K) || isNaN(M) || (P.push(M), Q.push(K)),
                        l ? Ka ? (this.lineColorSwitched = ra, this.fillColorsSwitched = sb) : (this.lineColorSwitched = Ba, this.fillColorsSwitched = Ia) : (this.lineColorSwitched = v.lineColor, this.fillColorsSwitched = v.fillColors),
                        this.dashLengthSwitched = v.dashLength;
                    ...
                    if (!isNaN(la) && !isNaN(V)) {
                        ...
                        if (r) {
                            if (N = E - h / 2, R = M, L = h, N + L > n && (L = n - N), 0 > N && (L += N, N = 0), N < n && 0 < L) {
                                var yb, zb;
                                V > la ? (yb = [F, Na], zb = [M, Ma]) : (yb = [M, Na], zb = [F, Ma]); ! isNaN(Na) && !isNaN(Ma) && E < n && 0 < E && (Ta = AmCharts.line(e, yb, [E, E], ta, T, Y), $a = AmCharts.line(e, zb, [E, E], ta, T, Y));
                                ea = F - M;
                            ...
                            Ab,
                            Bb;
                            V > la ? (Ab = [E, Da], Bb = [K, Ca]) : (Ab = [K, Da], Bb = [E, Ca]); ! isNaN(Da) && !isNaN(Ca) && F < m && 0 < F && (Ta = AmCharts.line(e, [F, F], Ab, ta, T, Y), $a = AmCharts.line(e, [F, F], Bb, ta, T, Y), AmCharts.setCN(a, Ta, this.bcn + "line-high"), v.className && AmCharts.setCN(a, Ta, v.className, !0), AmCharts.setCN(a, $a, this.bcn + "line-low"), v.className && AmCharts.setCN(a, $a, v.className, !0))
                        }
                ...
                if (!S && !isNaN(V)) {
                    ...
                    if (this.end - this.start <= Pb || 0 === Pb) {
                        ...
                        Qb = this.labelText;
                        if (Qb) {
                            var Gb = this.createLabel(v, fa, ga, Qb); (Gb = this.positionLabel(xa, ya, Gb, $b, L, ea)) && this.allBullets.push(Gb)
                        }
                        if ("regular" == X || "100%" == X) {
                            var Rb = f.totalText;
                            if (Rb) {
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(x, t, P, Q) : this.drawLineGraph(x, t, P, Q),
    ...
    drawLineGraph: function(a, b, c, d) {
        ...
        if (1 < a.length) {
            ...
            u && (q = u);
            var z = e.dashLength; (u = e.dashLengthSwitched) && (z = u);
    ...
    drawSmoothedGraph: function(a, b, c, d) {
        if (1 < a.length) {
            ...
            t && (p = t); (t = this.fillColorsSwitched) && (r = t);
    ...
    createBullet: function(a, b, c, d) {
        if (!isNaN(b) && !isNaN(c)) {
            ...
            if (this.customBullet || a.customBullet) r = this.customBullet,
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        this.line = e; (f = this.fullRectSet) ? (f.push(e), f.translate(this.x, this.y)) : this.set.push(e);
        ...
        this.setBalloonBounds(d, c, m); (a = this.vaBalloon) && this.setBalloonBounds(a, this.valueLineAxis, !m);
        this.hideCursor()
    },
            ...
            if (r) {
                ...
                if (c.mouseIsOver || A || C || this.forceShow) if (this.forceShow = !1, C) {
                    ...
                    if (this.oneBalloonOnly) {
                        q = Infinity;
                        for (g = 0; g < B.length; g++) t = B[g],
                        t.showBalloon && !t.hidden && t.balloonText && (w = r.axes[t.valueAxis.id].graphs[t.id], x = w.y, isNaN(x) || (u ? Math.abs(e - x) < q && (q = Math.abs(e - x), H = t) : Math.abs(f - x) < q && (q = Math.abs(f - x), H = t)));
                    ...
                    if (a != this.previousIndex || H != this.previousMostCloseGraph) if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                        ...
                        for (g = 0; g < B.length; g++) if (t = B[g], x = NaN, (!this.oneBalloonOnly || t == H) && t.showBalloon && !t.hidden && t.balloonText && ("step" == t.type && "left" == t.stepDirection && (r = this.data[a + 1]), r)) {
                            if (w = r.axes[t.valueAxis.id].graphs[t.id]) x = w.y;
                            if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length) for (q = a + 1; q < this.data.length; q++) if (d = this.data[q]) if (w = d.axes[t.valueAxis.id].graphs[t.id], x = w.y, !isNaN(x)) break;
                            if (!isNaN(x)) {
                                d = w.x;
                                k = !0;
                                if (u) {
    ...
    draw: function() {
        ...
        if (l = a.graph) {
            ...
            for (r = 0; r < c.length; r++) {
                ...
                u;
                for (u in q) if (q.hasOwnProperty(u) && "percents" != u && "total" != u) {
                    var z = q[u];
                    z < f && (f = z);
                    z > g && (g = z)
                }
                ...
                for (C = 0; C < A.length; C++) {
                    ...
                    for (H = 0; H < a.length; H++) {
                        ...
                        if (b.valueAxis.id == B) {
                            ...
                            var oa = y;
                            b.dataProvider && (oa = c);
                            ca.values = this.processValues(oa, b, X); ! b.connect && t && t[D] && w.time - r[D] >= q * I && (t[D].gap = !0);
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = 0;
        if (e = this.title) e = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0),
        AmCharts.setCN(a, e, "legend-title"),
        e.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1),
        a = e.getBBox(),
    ...
    arrangeEntries: function() {
        ...
        for (w = 0; w < x.length; w++) {
            ...
            H.translate(D, C);
            y++; ! isNaN(k) && y >= k && (y = 0, r++, C = C + B + l, B = 0);
            z.push(H)
        }
        t = z.getBBox();
        k = t.height + 2 * l - 1;
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings) {
                ...
                if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) g = k.set(),
                a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR),
                m = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength),
                AmCharts.setCN(b, m, "graph-line"),
                g.push(m),
                a.bullet && (a.hidden || (d = a.bulletColorR), m = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (AmCharts.setCN(b, m, "graph-bullet"), m.translate(l + 1, l / 2), g.push(m)),
                p = 0,
                m = l,
                n = l / 3;
                else {
            ...
            AmCharts.setCN(b, k, a.className, !0); (f = this.switchType) && "none" != f && ("x" == f ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == f ? c.hide() : c.show() : "x" != f && c.hide(), this.switchable || c.hide(), this.addListeners(c, a), a.legendSwitch = c, k.push(c), AmCharts.setCN(b, c, "legend-switch"));
            f = this.color;
